<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-950">
    ...
    <div v-if="isSidebarOpen" class="fixed inset-0 z-40 md:hidden">
      <!-- Overlay sombre -->
      <div class="absolute inset-0 bg-gray-900/50 transition-opacity" @click="isSidebarOpen = false" />
      ...
      <div class="hidden md:flex md:flex-shrink-0">
        <div class="flex flex-col w-64 border-r border-gray-200 dark:border-gray-800">
          <div class="p-4 border-b border-gray-200 dark:border-gray-800 flex items-center">
            ...
            <h1 class="text-lg font-semibold text-gray-900 dark:text-white">OKR App</h1>
          </div>
          <SidebarNavigation />
        </div>
      </div>
          ...
          <div class="flex items-center justify-between h-16 px-4">
            ...
            <div class="flex items-center ml-auto">
              <div class="relative">
                ...
                >
                  <NuxtLink to="/profile" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-primary-600 dark:hover:text-primary-400" @click="isUserMenuOpen = false">
                    <span class="flex items-center">
                      <UIcon name="i-heroicons-user" class="mr-2 h-4 w-4" />
                      Profil
                    </span>
                  </NuxtLink>
                  <NuxtLink to="/settings" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-primary-600 dark:hover:text-primary-400" @click="isUserMenuOpen = false">
                    <span class="flex items-center">
                      <UIcon name="i-heroicons-cog-6-tooth" class="mr-2 h-4 w-4" />
                      Paramètres
                    </span>
                  </NuxtLink>
                  <div class="border-t border-gray-200 dark:border-gray-700 my-1" />
                  <NuxtLink to="/login" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-primary-600 dark:hover:text-primary-400" @click="isUserMenuOpen = false">
                    <span class="flex items-center">
